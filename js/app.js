...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        fileInput.addEventListener("change", (function() {
            ...
            filePreview.innerHTML = `\n            <span>${fileName}</span>\n            <button id="delete-file">Видалити</button>\n        `;
    ...
    let deadlineValueSet = false;
    document.addEventListener("formSent", (function(e) {
        e.preventDefault();
        const cityInput = e.detail.form.querySelector("#city");
        const selectInput = e.detail.form.querySelector("#deadline");
        if (!cityInput || !selectInput) {
            console.error("City or deadline input field not found in the submitted form.");
            return;
        }
        const cityValue = cityInput.value;
        const selectValue = selectInput.value;
        const isHeroForm = e.detail.form.classList.contains("form-hero");
        const isChanceForm = e.detail.form.classList.contains("form-chance");
        const offerFormCityInput = document.querySelector('.form-offer input[name="city"]');
        if (offerFormCityInput) offerFormCityInput.value = cityValue; else {
            console.error("City input field not found in the second form.");
            return;
        }
        if (!deadlineValueSet && (isHeroForm || isChanceForm)) {
            const offerFormDeadlineInput = document.createElement("input");
            offerFormDeadlineInput.type = "hidden";
            offerFormDeadlineInput.name = "deadline";
            offerFormDeadlineInput.value = selectValue;
            const formOffer = document.querySelector(".form-offer");
            formOffer.appendChild(offerFormDeadlineInput);
            deadlineValueSet = true;
        }
        const blockId = "offer";
        const blockElement = document.getElementById(blockId);
        if (blockElement) blockElement.scrollIntoView({
            behavior: "smooth"
